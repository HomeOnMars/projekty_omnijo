---
Title: OmniCentraj Specifoj
Abstract: "Table of contents regarding the background stories and technical specifications for my fictional Cities: Skylines 2 city *OmniCentro*."
...
Authors:
  - "[[HomeOnMars]]"
Location: "[[Regnʌ_Omnijo]]"
URL: https://github.com/HomeOnMars/projekty_omnijo/blob/master/OmniCentro/_OmniCentro.md
---
...
Table of contents regarding the background stories and technical specifications for my fictional Cities: Skylines 2 city *OmniCentro* ([Paradox Mod ID 97163](https://mods.paradoxplaza.com/mods/97163/Any)).

![RO emblem](../fig/ROFlago.svg)  
*Regnʌ Omnijo* (RO) [flag](../fig/Emblemo.md#desegnoj) (fictional)
...
- [***Sigloj***  | Acronyms](Sigloj.md#sigloj)
<!--
- [***Politikoj***  | Policies](Politikoj.md#politikoj)
- [***Oftaj Demandoj***  | FAQ](OftajDemandoj.md#oftaj-demandoj)
-->
- [***La Historio*** | The History](Historio.md#la-historio): Main backstory starting here.
...
- [***Lingvo***  | Language](../tek/Lingvo.md#fonrakonto-de-la-epopo): *Epopo* — The new official language of RO.
